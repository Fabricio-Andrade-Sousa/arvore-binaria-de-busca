...
class Arvore:
    ...
    def exibir_arvore(self, raiz=None):
        ...
        titulo = tk.Label(janela, text='Árvore binária de busca',
    ...
    # Criação da janela e do canvas
        ...
        remover = tk.Button(janela, text='Remover', command=remover_arvore,
                            bg='red', fg='white').place(x=10, y=600)
        adicionar = tk.Button(janela, text='Adcionar', command=adicionar_arvore,
                              bg='green', fg='white').place(x=75, y=600)
